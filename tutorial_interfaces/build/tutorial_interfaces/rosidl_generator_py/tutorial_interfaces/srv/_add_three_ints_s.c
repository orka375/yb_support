...
bool tutorial_interfaces__srv__add_three_ints__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tutorial_interfaces.srv._add_three_ints", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("AddThreeInts_Request", (char *)PyUnicode_1BYTE_DATA(name_attr), 20) == 0);
...
bool tutorial_interfaces__srv__add_three_ints__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("tutorial_interfaces.srv._add_three_ints", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("AddThreeInts_Response", (char *)PyUnicode_1BYTE_DATA(name_attr), 21) == 0);
...
bool tutorial_interfaces__srv__add_three_ints__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    // PyUnicode_1BYTE_DATA is just a cast
    assert(strncmp("tutorial_interfaces.srv._add_three_ints", (char *)PyUnicode_1BYTE_DATA(module_attr), 39) == 0);
    assert(strncmp("AddThreeInts_Event", (char *)PyUnicode_1BYTE_DATA(name_attr), 18) == 0);
